...
| **依頼番号** | 20260308-001 |
| **依頼日** | 2026-03-08 |
| **対象システム** | カスミPOS 本番環境 / STG環境 |
| **対象サービス** | Amazon RDS Aurora MySQL 8.0 |
| **対象クラスター** | PRD: `ksm-posprd-db-cluster` / STG: `ksm-posstg-db-cluster` |
| **優先度** | 高 |
| **担当** | インフラ担当 |
...
> **2026-03-11 STG調査で確認**: STG環境（ksm-posstg-db-cluster / ksm-posstg-db-cluster-replica）も同様にバックアップ保持期間が1日のみ。PRD/STG両環境で対応が必要。
