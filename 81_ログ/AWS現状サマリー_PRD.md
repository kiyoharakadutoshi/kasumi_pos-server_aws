...
### サービス別コスト構成（6ヶ月合計 $21,683）

| サービス | 金額 | 構成比 | 妥当性 |
|---|---|---|---|
| RDS（Aurora） | $13,306 | 61.4% | ❌ **非妥当**（4〜8倍過剰スペック。CPU 0.015%、IOPS最大62） |
| Transfer Family | $3,324 | 15.3% | ⚠️ やや非妥当（3台→1台統合で$432/月削減可能） |
| EC2 | $1,261 | 5.8% | ✅ 妥当 |
| VPC | $803 | 3.7% | ✅ 妥当（削減困難） |
| EC2その他 | $319 | 1.5% | ✅ 妥当 |
| セキュリティ（GD/SH/Insp） | $338 | 1.6% | ✅ 妥当（PRDは正しく有効化） |
| その他 | $332 | 1.5% | ✅ 妥当 |
...
| RDS +RI 1年購入 | aws_006 | +$421 | +$5,055 | 上記後に検討 |
