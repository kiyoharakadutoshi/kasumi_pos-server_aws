...
export interface IButtonBottomCommonProps {
  ...
  return (
    <div className="bottom-button" style={{ '--lef-position': leftPosition } as any}>
      ...
      <div className="bottom-button__action-button button-normal">
        ...
        {deleteAction && <ButtonPrimary onClick={deleteAction} disabled={disableDelete} text="label.f10Delete" />}
        {editAction && <ButtonPrimary onClick={editAction} disabled={disableEdit} text="label.f7Edit" />}
        {addAction && <ButtonPrimary onClick={addAction} disabled={disableAdd} text="label.f11Create" />}
        {copyAction && <ButtonPrimary onClick={copyAction} disabled={disableCopy} text="label.f8Copy" />}
        {confirmAction && <ButtonPrimary onClick={confirmAction} disabled={disableConfirm} text="label.f9Confirm" />}
      </div>
    </div>
  );
};
export default ButtonBottomCommon;
