...
const PagingBottomButton = (props: IPagingBottomButtonProps) => {
  const disableFirstRowButton =
    props?.disableFirstRow || !props?.total_record || props?.total_record === 0 || props?.page === 1;
  const disableLastRowButton =
    props?.disableLastRow || !props?.total_record || props?.total_record === 0 || props?.page >= props?.totalPage;
  const disablePrevButton = props?.disablePrevPage || props?.page <= 1;
  const disableNextButton =
    props?.disableNextPage ||
    props?.total_record === 0 ||
    props?.page > props?.totalPage ||
    (props?.page === props?.totalPage && props?.total_record % props?.limit !== 0);
  ...
  useEffect(() => {
    ...
    props?.disableClear,
    props?.disableNextPage,
    props?.disablePrevPage,
    disableLastRowButton,
