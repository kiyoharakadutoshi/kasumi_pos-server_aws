            ...
            <div className="page-change-password__list">
              <div className="page-change-password__list-item">
                <div className="page-change-password__old-password">
                  <PopoverLabelText text={userDetail?.user_id} label='changePasswordScreen.userId'/>
                  <PopoverLabelText text={userDetail?.user_name} label='changePasswordScreen.userName'/>
                  <InputControl
