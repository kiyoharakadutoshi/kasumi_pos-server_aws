...
export const cashRegisterStatusReferenceItems: IDropDownItem[] = [
  ...
  { value: 2, name: 'cashRegisterStatus.reflectFailure' },
  { value: 3, name: 'cashRegisterStatus.reflected' },
];
...
export const cashRegisterStatusReference = {
  ...
  2: 'cashRegisterStatus.reflectFailure',
  3: 'cashRegisterStatus.reflected',
};
