...
import { getListPromotion, IListPromotionSearch, IPromotionDetail } from 'app/services/promotion-service';
...
export const ModalPromotion: React.FC<IModalListPromotionProps> = ({ showModal, selected_store, closeModal, product }) => {
  ...
  const handleSearch = () => {
    const query: IListPromotionSearch = { selected_store, promotion_code: code, limit: LIMIT_RECORD };
    if (isNullOrEmpty(query.promotion_code)) {
      delete query.promotion_code;
    }
