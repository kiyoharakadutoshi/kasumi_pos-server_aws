      ...
      */
      ...
      plugins: [
        ...
        new webpack.DefinePlugin({
          ...
          SERVER_API_URL: JSON.stringify(options.input == "spk" ? environment.SERVER_API_URL : environment.SERVER_API_URL_STAGING),
          SERVER_BATCH_API_URL: JSON.stringify(options.input == "spk" ? environment.SERVER_BATCH_API_URL : environment.SERVER_BATCH_API_STAGING_URL),
          STAGING_ENV: JSON.stringify(environment.STAGING_ENV),
          DOMAIN_INAGEYA: JSON.stringify(environment.DOMAIN_INAGEYA),
        }),
        new ESLintPlugin({
          baseConfig: {
            parserOptions: {
