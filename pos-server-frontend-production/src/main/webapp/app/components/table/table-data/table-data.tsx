...
const TableData = <TRow extends RowBase>(props: TableDataProps<TRow>) => {
  const { fieldSelectedRowsName = 'selectedRows' } = props;
            ...
            <Virtuoso
              ...
              itemContent={(indexRow) => {
                ...
                return (
                  <tr
                    key={row?.id}
                    className={`table-data__row-data ${redText} ${
                      !enableSelectRow ? 'row-data-non-select' : 'row-data-can-select'
                  ...
                  >
                    {row?.getVisibleCells().map((cell) => {
                      ...
                      const styleProps =
                        (columnDef as ExtendedColumnDef<TRow>).accessorKey === styleChange.columnName && styleChange;
